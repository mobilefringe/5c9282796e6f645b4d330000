<template>
	<div class="promo_dets_container" v-if="currentJob">
		...
		<div class="site_container">
			<router-link class="col-sm-12" style="margin-bottom: 10px" to="/jobs"><i class="fa fa-angle-left"></i> {{$t("jobs_page.back_to_jobs")}}</router-link>
			<div class="row">
				<div class="col-sm-4 promo_logo_container hidden_phone">
					...
					<div class="text-center" v-if="currentJob.store.name">
						...
						<div class="contest_btn caps" v-if="currentJob.jobable_type == 'Store'">
				...
				<div class="col-sm-8 promo_image_container text-left">
					...
					<div class="row">
						...
						<p class="promo_div_date pull-left" v-if="isMultiDay(currentPromo)"><i class="fa fa-calendar"></i>{{currentJob.start_date | moment("MMM D", timezone)}} - {{currentPromo.end_date | moment("MMM D", timezone)}}</p>
					...
					<social-sharing :url="$root.shareURL('jobs',currentJob.slug)" :title="currentJob.title" :description="currentJob.body" :quote="_.truncate(currentJob.description, {'length': 99})" :twitter-user="$root.twitter_user" :media="currentJob.image_url" inline-template >
						<div class="blog-social-share" style="margin: 0">
