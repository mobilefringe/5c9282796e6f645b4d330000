			...
			<div class="row">
				...
				<div class="col-sm-8 promo_image_container text-left">
					...
					<div class="row">
						...
						<p class="promo_div_date pull-left" v-if="isMultiDay(currentPromo)"><i class="fa fa-calendar"></i>{{currentJob.start_date | moment("MMM D", timezone)}} - {{currentJob.end_date | moment("MMM D", timezone)}}</p>
