                    ...
                    <form class="form-horizontal" action="form-submit" @submit.prevent="validateBeforeSubmit">
                        <div class="form-group ">
                            ...
                            <div class="col-sm-12" :class="{'has-error': errors.has('phone')}">
                                ...
                                <input v-model="form_data.phone" rules="numeric" v-validate="'required|numeric'" class="form-control" :class="{'input': true}" name="phone number" type="tel" placeholder="Phone Number" data-vv-delay="500" id="contact_phone" required>
