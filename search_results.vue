        			...
        			<div v-for="(result,index) in searchResults" :key="index">
                        <div class="row result_container_row">
                            <div v-if="result.is_store" class="col-sm-3 store_details_image center-block">
                                ...
                                <div v-else>
                                    <img v-if="result.store" class="result_logo" :src="result.image_url"/>
                            ...
                            <div v-else class="col-sm-3 store_details_image center-block">
                                <img v-if="result.store.image_url != null" class="result_logo nana" :src="result.store.image_url"/>   
                                <img v-else class="lala" :src="result.image_url" />
                            </div>
