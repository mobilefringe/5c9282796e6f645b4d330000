        			...
        			<div v-for="(result,index) in searchResults" :key="index">
                        <div class="row result_container_row">
                            <div v-if="result.is_store" class="col-sm-3 store_details_image center-block">
                                ...
                                <div v-else>
                                    <img v-if="result.store" class="result_logo haha" :src="result.image_url"/>
                                    <img v-else-if="result.store_front_url_abs" class="result_logo nono" :src="result.store_front_url_abs"/>
                                </div>
                            </div>
                            <div v-else class="col-sm-3 store_details_image center-block">
                                <img class="result_logo" :src="property.default_logo_url_black"/>    
                            </div>
