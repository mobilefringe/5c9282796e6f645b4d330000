		...
		<div class="site_container">
			...
			<div class="row">
				<div class="col-sm-12 promo_image_container margin_40 text-left">
					...
					<div class="row">
						<p class="promo_div_date pull-left" v-if="isMultiDay(currentEvent)">{{currentEvent.start_date | moment("MMM D", timezone)}} - {{currentEvent.end_date | moment("MMM D", timezone)}}</p>
						<p class="promo_div_date pull-left" v-else>{{currentEvent.start_date | moment("MMM D", timezone)}}</p>
					</div>
