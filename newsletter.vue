        ...
        <div class="site_container">
            ...
            <div class="row"> 
                <div class="col-md-12 contact_contents">
                    <form class="form-horizontal js-cm-form" action="https://mobilefringe.createsend.com/t/d/s/wtdltt/" method="post" data-id="92D4C54F0FEC16E5ADC2B1904DE9ED1A124F5357173781B1056D924E694242F2413242981A3E38F729032322E1421780E5AFF1CA71953B960F79CC08689700B6">
                    ...
                    this.$validator.validateAll().then((result) => {
                        ...
                        if(errors && errors.items.length == 0){ 
                            if(errors.length > 0) {
                                ...
                                this.campaignMonitorCall($('#subForm'), '92D4C54F0FEC16E5ADC2B1904DE9ED1A124F5357173781B1056D924E694242F2413242981A3E38F729032322E1421780E5AFF1CA71953B960F79CC08689700B6'); 
                            }
                        }
                    })
                },
