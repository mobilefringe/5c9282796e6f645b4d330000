		...
		<div class="site_container">
			...
			<div class="row">
				<div class="col-sm-12 promo_image_container margin_40 text-left">
					...
					<div class="row">
						<p class="promo_div_date pull-left" v-if="isMultiDay(currentPromo)">{{currentPromo.start_date | moment("MMM D", timezone)}} - {{currentPromo.end_date | moment("MMM D", timezone)}}</p>
						<p class="promo_div_date pull-left" v-else>{{currentPromo.start_date | moment("MMM D", timezone)}}</p>
					</div>
					...
					<div class="col-sm-12 no_padding text-left">
						...
						<img v-else class="image" :src="currentPromo.image_url" :alt="currentPromo.name" />
